...
export default function PublicProfilePage({ params }: { params: { username: string } }) {
  ...
  const handleFollow = async () => {
    if (!isAuthenticated || !profile) { setShowAuthPrompt(true); return; }
    ...
    <div style={{ minHeight: "100vh", background: "#0c0010", color: "#fff" }}>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div style={{
          ...
          {/* Big Secrely text — decorative, fully inside cover */}
          <div style={{
            ...
            <span style={{
              ...
              lineHeight: 1,
              background: "linear-gradient(135deg, rgba(240,171,252,0.14) 0%, rgba(167,139,250,0.07) 100%)",
        ...
        <div style={{ maxWidth: 640, margin: "0 auto", padding: "12px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{
              ...
              <span style={{ color: "#fff", fontSize: 12, fontWeight: 900, letterSpacing: "-0.03em" }}>S</span>
            </div>
            <span style={{
              fontSize: 15, fontWeight: 700, letterSpacing: "-0.02em", color: "rgba(255,255,255,0.7)",
            }}>Secrely</span>
          </Link>
